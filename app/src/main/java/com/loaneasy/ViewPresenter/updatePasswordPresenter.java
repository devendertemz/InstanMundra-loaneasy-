...
public class updatePasswordPresenter {
    ...
    public updatePasswordPresenter(UserLoginView view) {
        this.view = view;
    }


    public void ForgetPasswordSendOTP(Context context, UpdatePasswordRequest loginRequest) {
        Call<ResponseBody> loginCall = ApiClientt.getApi(context).saveNewPassword(loginRequest);
